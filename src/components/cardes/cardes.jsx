            ...
            <Grid container spacing={3} justify="center">
                <Grid item component={Card} xs={12} md={3} className={cx(styles.cardes, styles.infected)}>
                    ...
                    <CardContent>
                        ...
                        <ListItemText>- New loss of taste or smell</ListItemText>
                        <ListItemText>- Chills</ListItemText>
                    </CardContent>
                </Grid>
                ...
                <Grid item component={Card} xs={12} md={3} className={cx(styles.cardes, styles.infected)}>
                    ...
                    <CardContent>
                        ...
                        <ListItemText>- Stay home and self isolated from the infected Person</ListItemText>
                        <ListItemText>- Regular hand wash with soap or use of sanitizer</ListItemText>
